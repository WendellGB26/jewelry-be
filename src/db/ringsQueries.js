...
const createRings = async (user) => {
  ...
  try {
    ...
    const result = await client.query('INSERT INTO rings (name, price, lenght, type, color, gender) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *', [name, price, lenght, type, color, gender]);
