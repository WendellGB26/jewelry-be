...
const createBracelets = async (user) => {
  ...
  try {
    ...
    const result = await client.query('INSERT INTO bracelets (name, description, price, size, color, gender, imagekey) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *', [name, description, price, size, color, gender, imagekey]);
